...
function OverView() {
  return (
    <div>
      <div className="grid xl:grid-cols-2 lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1 xl:gap-[50px] lg:gap-[50px] md:gap-[30px] sm:gap-[20px] gap-[20px] px-[20px] py-[20px] over-view">
        <div className="">
        ...
        <div className="flex flex-col justify-center text">
          ...
          <div className="p flex flex-col gap-[10px] pr-[20px]">
