...
function Source2() {
  return (
    ...
    <div className='w-[900px] source-outer shadow-sm relative top-[-45px]  bg-opacity-10 bg-white px-[20px] py-[20px] rounded-tr-[50px] rounded-bl-[50px]  rounded-br-[50px]'>
...
<div className='shadow-sm w-[320px] h-[231px] flex flex-col justify-center items-center rounded-[20px]'>
