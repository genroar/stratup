...
function Homesource() {
  return (
    <div className=''>
         <div className='  source-outer shadow-top shadow-sm relative top-[-45px]  bg-opacity-10 bg-white px-[20px] py-[20px] rounded-tr-[50px] rounded-bl-[50px]  rounded-br-[50px]'>
