    ...
    <div className='flex justify-between w-[990px] px-[20px] py-[20px] items-center'>
        ...
        <div className='lft flex items-center gap-[15px]'>
            <div className='flex gap-[6px]'>
                <div className='text-green-500 bg-green-100 w-[35px] h-[35px] rounded-[100%] flex justify-center items-center'><BsFillTagFill /></div>
                <span className='text-[13px] items-center flex  font-normal text-gray-800 text-opacity-80'>Mark as sold</span>
            </div>
            <div className='flex gap-[6px]'>
                <div className='w-[35px] h-[35px] rounded-[100%] flex justify-center items-center text-blue-500 bg-blue-100'><HiPencil /></div>
                <span className='text-[13px] items-center flex  font-normal text-gray-800 text-opacity-80'>Edit</span>
            </div>
            <div className='flex gap-[6px]'>
                <div className='w-[35px] h-[35px] rounded-[100%] flex justify-center items-center text-red-500 bg-red-100'><MdDelete /></div>
