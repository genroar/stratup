...
function ListingButton({ buy, sell, source, consign }) {
  ...
  return (
    <div className="flex xl:w-[40%] lg:w-[40%] md:w-[60%] sm:w-[85%] w-[95%] divide-x-[1px] divide-gray-300 shadow-t-custom listingbutton transform rotate-y-1 rounded-tr-[25px] h-[60px]  rounded-tl-[25px]" >
