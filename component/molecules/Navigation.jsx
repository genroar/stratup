...
function Navigation() {
  ...
  const listStyle = 'xl:mb-[] lg:mb-[] mb-[20px]';
  return (
    ...
    <div className='xl:flex lg:flex block text-gray-300 text-[16px] font-normal gap-[30px]'>
      <ul className='xl:flex lg:flex xl:gap-[30px]  lg:gap-[13px]'>
        ...
        <li className={listStyle}><Link className={fontSize} href='/consign'>Consign</Link></li>
        <li className={listStyle}><Link className={fontSize} href='/about'>About Us</Link></li>
        <li className={listStyle}><Link className={fontSize} href='/blog'>Blog</Link></li>
      </ul>
