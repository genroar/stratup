...
function Footer() {
  return (
    <div className="main-footer  footer  ">
      <div className="  xl:py-[50px]  lg:py-[50px] md:py-[50px] sm:flex sm:justify-center sm:items-center sm:py-[30px] py-[20px]">
        <Container>
        <div className="grid xl:grid-cols-3 lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-2 grid-cols-1 xl:gap-[50px] lg:gap-[50px] md:gap-[50px] sm:gap-[50px] gap-[20px] ">
